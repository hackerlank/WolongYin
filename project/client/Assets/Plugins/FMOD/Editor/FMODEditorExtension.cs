...
public class FMODEditorExtension : MonoBehaviour
{
	...
	{		
		...
		foreach (var fileInfo in info.GetFiles())
		{
			...
			var oldBankPath =  AutoBuildCommonUtil.GetFMODBankPath() + fileInfo.Name;
			//Application.dataPath + "/StreamingAssets/" + fileInfo.Name;
		...
		foreach (var fileInfo in banksToCopy)
		{
			...
			var oldBankPath = AutoBuildCommonUtil.GetFMODBankPath() + fileInfo.Name; //Application.dataPath + "/StreamingAssets/" + fileInfo.Name;
        ...
        System.IO.File.WriteAllText(AutoBuildCommonUtil.GetFMODBankPath() + "FMOD_bank_list.txt", bankNames);
	...
	static bool LocateProject(ref string filePath)
	{
		...
		
		{
            ...
            filePath = AutoBuildCommonUtil.GetDefaultBankProject(); //EditorUtility.OpenFolderPanel("Locate build directory", defaultPath, "Build");
