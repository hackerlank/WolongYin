    ...
    public static class PlayerPrefs
    {
        ...
        public static void Flush()
        {
            if (hashTableChanged)
            {
                ...
                if (fileWriter == null)
                {
                    Logger.instance.Warning("PlayerPrefs::Flush() opening file for writing failed: " + fileName);
                }
        ...
        private static void Deserialize()
        {
            ...
            foreach (string parameter in parameters)
            {
                ...
                {
                    Logger.instance.Warning("PlayerPrefs::Deserialize() parameterContent has " + parameterContent.Length + " elements");
                }
            }
        }
        ...
        public static object GetTypeValue(string typeName, string value)
        {
            ...
            {
                Logger.instance.Error("Unsupported type: " + typeName);
            }
